...
def main():
    ...
    accelerator = Accelerator(gradient_accumulation_steps=args.gradient_accumulation_steps, mixed_precision="bf16", **accelerator_log_kwargs)
    ...
    if args.teacher_model_name_or_path is not None:
        ...
        assert teacher_model.get_input_embeddings().weight.shape[0] == len(tokenizer), "The teacher model should use the same tokenizer"
            ...
            with accelerator.accumulate(model):
                ...
                if args.teacher_model_name_or_path is not None:
                    ...
                    def ce_loss(student_logits, teacher_logits):
                        ...
                        return loss
                    loss = ce_loss(student_logits, teacher_logits)
                else:
                    loss = outputs.loss
