...
def main(model_name_or_path: str, save_dir: str, ngpu: int, bit: float, size: int=16):
    ...
    if bit == 4.14: # size = 4
        layers = {
            ...
            'k_proj.weight': [1, 10000],
            'v_proj.weight': [1, 10000],
            'o_proj.weight': [1, 38000],
            'gate_proj.weight': [2, 65000],
            'up_proj.weight': [2, 65000],
            'down_proj.weight': [2, 65000],
        }
    elif bit == 3: # size = 6, n = 110000
        layers = {
            'q_proj.weight': [1, 60000],
            'k_proj.weight': [1, 15000],
            'v_proj.weight': [1, 15000],
            'o_proj.weight': [1, 60000],
            'gate_proj.weight': [4, 52000],
            'up_proj.weight': [4, 52000],
            'down_proj.weight': [4, 52000],
        }
    elif bit == 2.28: # size = 8, n = 66000
        layers = {
            'q_proj.weight': [1, 36000],
            'k_proj.weight': [1, 9000],
            'v_proj.weight': [1, 9000],
            'o_proj.weight': [1, 36000],
            'gate_proj.weight': [2, 62000],
            'up_proj.weight': [2, 62000],
            'down_proj.weight': [2, 62000],
        }
    elif bit == 2.14: # size = 8, n = 32000
        layers = {
            'q_proj.weight': [1, 18000],
            'k_proj.weight': [1, 5000],
            'v_proj.weight': [1, 5000],
            'o_proj.weight': [1, 18000],
            'gate_proj.weight': [1, 60000],
            'up_proj.weight': [1, 60000],
            'down_proj.weight': [1, 60000],
        }
    elif bit == 2: # size = 9, n = 50000
        layers = {
            'q_proj.weight': [1, 27000],
            'k_proj.weight': [1, 7000],
            'v_proj.weight': [1, 7000],
            'o_proj.weight': [1, 27000],
            'gate_proj.weight': [2, 47000],
            'up_proj.weight': [2, 47000],
            'down_proj.weight': [2, 47000],
        }
